...
@php
    ...
    $statusMap = [
        ...
        'ACCEPTED' => 'text-bg-success', 'CONVERTED' => 'text-bg-success', 'CLEAN' => 'text-bg-success',
        ...
        'CLOSED' => 'text-bg-secondary', 'NOT_CONFIGURED' => 'text-bg-secondary', 'READ' => 'text-bg-secondary',
        'INTERNAL' => 'text-bg-secondary',
