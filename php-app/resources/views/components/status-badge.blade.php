...
@php
    ...
    $statusMap = [
        ...
        'ACCEPTED' => 'text-bg-success', 'CONVERTED' => 'text-bg-success', 'POSTED' => 'text-bg-success', 'CLEAN' => 'text-bg-success',
        'PUBLISHED' => 'text-bg-success', 'COMPLETED' => 'text-bg-success', 'PRODUCTION_APPROVED' => 'text-bg-success', 'CONFIGURED' => 'text-bg-success',
        ...
        'INVITED' => 'text-bg-info', 'LOCAL_STAGING_READY' => 'text-bg-info',
        'EXCEPTION' => 'text-bg-danger', 'REJECTED' => 'text-bg-danger', 'REJECTED_BY_PROVIDER' => 'text-bg-danger', 'FAIL' => 'text-bg-danger',
        'INFECTED' => 'text-bg-danger', 'RESTRICTED' => 'text-bg-danger', 'OVERDUE' => 'text-bg-danger',
        ...
        'CONTRACT_PENDING' => 'text-bg-warning', 'CONFIGURATION_PENDING' => 'text-bg-warning', 'CONFORMANCE_PENDING' => 'text-bg-warning',
        'REQUIRES_ITAS_CONFIRMATION' => 'text-bg-warning', 'REQUIRES_SECURITY_DECISION' => 'text-bg-warning',
    ];
    $riskMap = [
        'LOW' => 'text-bg-success',
        'MEDIUM' => 'text-bg-info',
