...
class PortalDefinitions
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'namra', 'name' => 'NamRA', 'audience' => 'Compliance, audit and refunds', 'description' => 'National work queues, taxpayer timelines, evidence and controlled decisions.', 'href' => '/portal/namra', 'capability' => null, 'roles' => ['NAMRA_COMPLIANCE_OFFICER', 'NAMRA_VAT_AUDITOR', 'NAMRA_VAT_SENIOR_AUDITOR', 'NAMRA_VAT_SUPERVISOR', 'NAMRA_SYSTEM_SUPPORT', 'NAMRA_SYSTEM_ADMIN', 'INFRASTRUCTURE_ADMIN', 'SUPER_ADMIN', 'SECURITY_ANALYST']],
