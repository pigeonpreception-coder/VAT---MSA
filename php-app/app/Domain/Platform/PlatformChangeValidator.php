...
class PlatformChangeValidator
{
    ...
    public const PLATFORM_STAFF_ROLES = [
        'SUPER_ADMIN', 'INFRASTRUCTURE_ADMIN', 'SECURITY_ANALYST', 'INTERNAL_AUDITOR', 'NAMRA_SYSTEM_SUPPORT',
        'NAMRA_SYSTEM_ADMIN', 'NAMRA_VAT_SUPERVISOR', 'NAMRA_COMPLIANCE_OFFICER', 'NAMRA_VAT_AUDITOR', 'NAMRA_VAT_SENIOR_AUDITOR',
    ];
