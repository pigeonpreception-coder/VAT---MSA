...
/**
 * Ported from lib/domain/payment.ts's PaymentValidationError. Unlike that
 * source class (a `messages` array, every failing field at once), this
 * carries only the first failure -- matching this migration's own
 * established single-error-at-a-time *ValidationException precedent (see
 * e.g. App\Exceptions\SecurityValidationException's own doc comment).
 */
