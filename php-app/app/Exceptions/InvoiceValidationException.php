...
/** Ported from lib/domain/invoice.ts's InvoiceValidationError -- a list of {code, path, message}, not a single message. */
class InvoiceValidationException extends \RuntimeException
{
    ...
    {
        parent::__construct('The invoice failed validation.');
    }
