...
- [ ] **Not built in this phase, deliberately deferred:** Phase E's segregation-of-duties enforcement (no check yet blocks the same actor from opening, closing, and issuing a finding on one case). *(Phase B's human-authorisation gate, listed here as deferred when this phase was written, was completed the same day — see Phase B below.)*
