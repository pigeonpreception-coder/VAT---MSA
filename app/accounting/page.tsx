...
export default async function AccountingPage() {
  ...
  return <AppShell active="accounting" permission="accounting:read">
    ...
    <section className="metric-grid">
      ...
      <article className="metric"><div className="metric-top"><span className="metric-label">Currency</span><span className="metric-icon">N$</span></div><div className="metric-value">N$</div><div className="metric-foot">Namibian-dollar reporting currency</div></article>
    </section>
