...
const ROLE_PERMISSIONS: Record<string, ReadonlySet<string>> = {
  ...
  NAMRA_REFUND_OFFICER: new Set(["dashboard:read", "taxpayers:read", "returns:read", "compliance:read", "refunds:read", "refunds:review", "risk:read", "communications:manage", "notifications:manage", "payments:read", "payments:record"]),
  NAMRA_SUPERVISOR: new Set(["dashboard:read", "identity:read", "taxpayers:read", "registrations:read", "invoices:read", "exceptions:read", "returns:read", "reconciliation:manage", "compliance:read", "cases:manage", "cases:override-sod", "disputes:manage", "obligations:manage", "refunds:read", "refunds:review", "risk:read", "risk:review", "communications:manage", "integrations:read", "integrations:manage", "taxpayer-systems:read", "taxpayer-systems:approve", "reports:read", "reports:run", "reports:executive", "platform:read", "payments:read", "payments:record", "audit:read", "vat-rules:read"]),
