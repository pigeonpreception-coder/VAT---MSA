...
const ROLE_PERMISSIONS: Record<string, ReadonlySet<string>> = {
  ...
  NAMRA_SYSTEM_ADMIN: new Set(["dashboard:read", "identity:read", "taxpayers:read", "registrations:read", "registrations:approve", "organisations:manage", "administration:read", "administration:manage"]),
