...
const ROLE_PERMISSIONS: Record<string, ReadonlySet<string>> = {
  PILOT_ADMIN: new Set(["dashboard:read", "identity:read", "taxpayers:read", "taxpayers:suspend", "registrations:read", "registrations:submit", "registrations:approve", "organisations:manage", "invoices:read", "invoices:submit", "invoices:cancel", "exceptions:read", "returns:read", "returns:generate", "returns:approve", "returns:submit", "vat-adjustments:manage", "vat-rules:read", "vat-rules:manage", "reconciliation:manage", "compliance:read", "cases:manage", "disputes:manage", "obligations:manage", "refunds:read", "refunds:request", "refunds:review", "risk:read", "risk:review", "communications:manage", "consents:manage", "integrations:read", "integrations:manage", "developer:read", "developer:manage", "offline:read", "offline:sync", "reports:read", "reports:run", "platform:read", "payments:read", "audit:read", "security:read", "commercial:read", "parties:manage", "quotations:manage", "accounting:read", "accounting:post", "expenses:read", "expenses:manage", "inventory:read", "inventory:manage", "projects:read", "projects:manage", "imports:read", "imports:manage", "documents:read", "documents:upload"]),
  ...
  NAMRA_SUPERVISOR: new Set(["dashboard:read", "identity:read", "taxpayers:read", "registrations:read", "invoices:read", "exceptions:read", "returns:read", "reconciliation:manage", "compliance:read", "cases:manage", "disputes:manage", "obligations:manage", "refunds:read", "refunds:review", "risk:read", "risk:review", "communications:manage", "integrations:read", "integrations:manage", "reports:read", "reports:run", "platform:read", "payments:read", "audit:read", "vat-rules:read"]),
